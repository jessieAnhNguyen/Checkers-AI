...
/**
* Class Minimax: contains the implementation of the minimax algorithm
**/
...
public class Minimax extends Bot {
    ...
    public char[][] makeMove(char[][] a, boolean isBlack) { // isBlack represents the side human player chooses to play
